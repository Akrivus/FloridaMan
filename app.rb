...
REDDIT = Redd.it(user_agent: 'Redd:FloridaMan:19.8.10 (by /u/akrivus)', client_id: ENV['REDDIT_CLIENTID'], secret: ENV['REDDIT_SECRETID'], username: ENV['REDDIT_USERNAME'], password: ENV['REDDIT_PASSWORD'])
FLORIDA_MAN_REGEX = /^florida (?:wo){0,1}man/i
